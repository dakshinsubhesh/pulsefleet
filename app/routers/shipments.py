...
async def list_shipments(
    ...
    if min_weight_kg is not None and max_weight_kg is not None and min_weight_kg > max_weight_kg:
        raise ValidationError(
            "min_weight_kg cannot be greater than max_weight_kg.",
    ...
    if min_weight_kg is not None:
        filters.append(models.Shipment.weight_kg >= min_weight_kg)
    if max_weight_kg is not None:
        filters.append(models.Shipment.weight_kg <= max_weight_kg)
