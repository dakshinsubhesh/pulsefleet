...
# ---------------------------------------------------------------------------
# Auth (Day 7: Authentication)
# ---------------------------------------------------------------------------

class UserCreate(BaseModel):
    username: str = Field(..., min_length=3, max_length=50)
    password: str = Field(..., min_length=8, max_length=72, description="Max 72 bytes (bcrypt limit)")
...
# ---------------------------------------------------------------------------
# Pagination (Day 5: Read workflows)
# ---------------------------------------------------------------------------
...
class Page(BaseModel, Generic[T]):
    """
    Generic paginated list envelope. Items are always in a stable order
    (ascending by primary key) so a given offset/limit returns consistent
    results across requests, even with concurrent writes.
    """
    items: list[T]
...
# ---------------------------------------------------------------------------
# Day 10 — Weather-risk evaluation schemas
# ---------------------------------------------------------------------------
